package net.chaofen.admin.aspect;
...
import net.chaofen.common.utils.StringUtils;
...
public class DaoAspect {
	...
	@Pointcut("execution(* net.chaofen.*.dao.*.update*(..))")
	public void daoUpdate() {
	}

	@Pointcut("execution(* net.chaofen.*.dao.*.insert*(..))")
